namespace Owin.Scim.Tests.Integration.Users.Create
{
    ...
    public class with_missing_schema : using_a_scim_server
    {
        ...
        Because of = () =>
        {
            Response = Server
                .HttpClient
                .PostAsync("users", new ObjectContent<UserWithNoSchema>(UserDto, new ScimJsonMediaTypeFormatter()))
                .Result;
        ...
        It should_return_invalid_value = () => Error?.ScimErrorType.ShouldEqual(ScimErrorType.InvalidValue);
